...
public class TC003_Post_Employee_Recored extends TestBase{
	...
	@BeforeClass
	void CreateEmpolyee() throws InterruptedException {

		logger.info("*** Started TC003_Post_Employee_Recored **** ");
	...
	void tearDown() {
		...
		logger.info("**** Finished TC003_Post_Employee_Recored ****");
	}
}
