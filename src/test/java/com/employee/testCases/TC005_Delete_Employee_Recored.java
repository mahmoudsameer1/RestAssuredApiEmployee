...
public class TC005_Delete_Employee_Recored extends TestBase {
	...
	void deleteEmployee() throws InterruptedException {
		...
		logger.info("*** Started TC005_Delete_Employee_Recored **** ");
	...
	void checkResponseBody() {
		...
		Assert.assertEquals(responseBody.contains("successfully! deleted Recoreds"), true);
	}
	...
	void tearDown() {
		...
		logger.info("**** Finished TC005_Delete_Employee_Recored ****");
	}
